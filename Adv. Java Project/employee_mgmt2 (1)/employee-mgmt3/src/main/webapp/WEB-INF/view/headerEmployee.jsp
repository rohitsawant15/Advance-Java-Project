  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
       ...
       <li class="nav-item active" >
        <a class="nav-link" href="#">Welcome:<c:out value = "${employee.fname}"/> &nbsp;<c:out value = "${employee.lname}"/></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" style="padding-right: 2px" href="/project_name/Logout">Logout</a>
      </li>
    </ul>
  </div>
</nav>